  ...
  return(
    <>
      <div className="absolute flex flex-col gap-10 justify-end items-end backdrop-blur-2xl z-60 left-1/2 bottom-0 -translate-x-1/2 h-screen w-screen">
        <div className="relative flex  justify-start items-start z-50 left-1/2 bottom-0 -translate-x-1/2 p-10 rounded-t-3xl h-[95%] w-screen bg-background shadow-2xs">
        <span className="absolute left-5 top-6">
        ...
        <div className="flex flex-col justify-center items-center pt-10 h-full w-full">
            <input type="text" placeholder="Edite seu nome" className="border-card-light border-2 rounded-3xl text-black p-1 pl-2">
            </input>
