...
function EventAlert({closeModal, isVisible, event}: Props){
  ...
  return(
    <>
      ...
      style={{visibility: isVisible?"visible":"hidden"}}>
        <div className="relative flex flex-wrap gap-5 overflow-auto justify-center items-center z-50 left-1/2 bottom-0 -translate-x-1/2 p-10 rounded-t-3xl rounded-b-3xl h-[80%] w-screen bg-background shadow-2xs">
